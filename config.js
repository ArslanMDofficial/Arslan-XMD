...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~8z1GXBzB#8WQr7ISwIUqKXMxj35vHm6oyQ_naSnjlmvulvgeiO7c",
// add your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "Arslan-XMD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "Arslan-XMD",
...
OWNER_NAME: process.env.OWNER_NAME || "Arslan-MD",
// add bot owner name 
...
MENTION_REPLY: process.env.MENTION_REPLY || "falpse",
// maks true for always online 
ANTI_CALL: process.env.ANTI_CALL || "true",
//maks anticall true, false for calls
REJECT_MSG: process.env.REJECT_MSG || "*📞 ᴄαℓℓ ɴσт αℓℓσωє∂ ιɴ тнιѕ ɴᴜмвєʀ уσυ ∂σɴт нανє ᴘєʀмιѕѕισɴ 📵*", 
// add anticall message 
DESCRIPTION: process.env.DESCRIPTION || "*© POWERED BY Arslan-MD💀*",
// add bot owner name    
